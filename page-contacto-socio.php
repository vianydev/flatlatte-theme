<?php 
/**
 * Template Name: Página de Contacto Socio flat latte
 */
get_header(); ?>
    ...
    <div class="container fullScreenView d-flex align-items-center" data-aos="fade">
      <div class="row justify-content-center ">
        <div class="col-12 col-lg-10 text-center">
          <div class="mb-5">
            <h1>¿Listo para ser socio Flat Latte? ☕</h1>
        ...
        <div class="col-12 col-lg-8 d-md-flex justify-content-center text-center gap-2">
            <div class="contact-btn">
              <a class="btn-get-started d-inline-flex justify-content-center align-items-center mb-2" href="https://wa.me/529223400366?text=Hola%20¿Me%20podrías%20dar%20información%20sobre%20como%20ser%20socio..." target="_blank" data-bs-toggle="modal" data-bs-target="#bookVideocall">
          ...
          <div class="contact-btn">
            <a class="btn-get-started d-inline-flex justify-content-center align-items-center mb-4" href="https://wa.me/529223400366?text=Hola%20¿Me%20podrías%20dar%20información%20sobre%20como%20ser%20socio..." target="_blank">
